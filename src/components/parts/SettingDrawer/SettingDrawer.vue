        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div :style="{ marginTop: '24px' }">
            <a-list :split="false">
              ...
              <a-list-item >
                <a-switch slot="actions" size="small" :disabled="(layoutMode === 'topmenu')" :defaultChecked="fixSidebar" @change="handleFixSidebar" />
                <a-list-item-meta>
...
export default {
  ...
  fixSidebar: ${this.fixSidebar}, // sticky siderbar
