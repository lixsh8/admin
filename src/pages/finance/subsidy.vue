  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: '补贴用户数',
          dataIndex: 'subsidyMemberCount'
        },
        {
          title: '新手补贴（0.3元） ',
          dataIndex: 'newSubsidyAmount'
        },
        {
          title: '好友合成物品补贴',
          dataIndex: 'synthesisSubsidyAmount'
        },
        {
          title: '合成红包补贴',
          dataIndex: 'giftSubsidyAmount'
        },
        {
          title: '升级红包补贴',
          dataIndex: 'upgradeSubsidyAmount'
        },
        {
          title: '年终奖补贴',
          dataIndex: 'bonusSubsidyAmount'
        }
        // ,
        // {
        //   title: '操作',
      ...
      loadData: parameter => {
        return finance.stat.subsidy({ ...this.queryParam, ...parameter }).then(data => {
          return data
        })
      }
    }
